...
function getViewerConfiguration() {
  return {
    ...
    currentPublicKey: document.getElementById('currentPublicKey'),
...
function webViewerLoad() {
  ...
  if (document.getElementById("documentURL") !== 'undefined') {
    pdfjsWebAppOptions.AppOptions.set("defaultUrl", document.getElementById("documentURL").innerText);
  }
          ...
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              if (typeof file === 'string') {
                ...
                parameters.url = file;
                parameters.publicKey = _this7.appConfig.currentPublicKey.innerText;
								parameters.sessionId = _this7.appConfig.currentSessionId.innerText;
  ...
  load: function load(pdfDocument) {
    ...
    pdfDocument.getDownloadInfo().then(function () {
      ...
      firstPagePromise.then(function () {
		...
		window.parent.postMessage(pdfDocument.fingerprint)
...
//      var pagesCount = pdfViewer.pagesCount;
      // 修改
      var pagesCount = LimitPage ? LimitPage : pdfViewer.pagesCount;
      ...
      Promise.all([this.overlayManager.open(this.overlayName), this._dataAvailableCapability.promise]).then(function () {
        ...
        _this2.pdfDocument.getMetadata().then(function (_ref2) {
          ...
          freezeFieldData({
            ...
            'pageCount':  LimitPage ? LimitPage : _this2.pdfDocument.numPages,
            'pageSize': pageSize,
  ...
  _createClass(PDFLinkService, [{
    ...
    value: function setHistory(pdfHistory) {
      this.pdfHistory = pdfHistory;
	    ...
	    key: "extendGetPageIndex",
	    value: function extendGetPageIndex(dest1,callback) {
	    	////////修改，增加返回目录所在页数的方法
	      var _this = this;
	      _this.pdfDocument.getPageIndex(dest1).then(function (pageIndex) {
	    	  callback(pageIndex);
	      })
	    }
  }
...
////////修改，增加试读目录置灰功能
      if(dest && dest[0]){
    	  linkService.extendGetPageIndex(dest[0],function(extendPageIndex){

    		  if(LimitPage && parseInt(extendPageIndex) >= LimitPage){
    			  $(element).addClass('need-buy');
    		  }
    	  })
      }
      ...
      element.onclick = function () {
        if (dest) {
        	$('#viewer').removeClass('extend-mt4');
          linkService.navigateTo(dest);
          setTimeout(function(){
        	  $('#viewer').addClass('extend-mt4');
          }, 10)
        }
        return false;
      };
...
//        });
//      });
      $(items.pageNumber).on('change',function() {
          eventBus.dispatch('pagenumberchanged', {
            source: self,
            value: this.value,
          })
